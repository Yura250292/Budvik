          ...
          update.viaBridge ? (
            ...
            >
              ...
              {update.signatureChange ? (
                /*
                  Збірка старша за перехід на постійний ключ підпису
                  (25.08). Android не поставить нову поверх неї — скаже
                  «пакет конфліктує», і це не помилка застосунку.
                */
                ...
                /*
                  Звичайне оновлення. Про знесення тут не пишемо навмисно:
                  воно коштує ненадісланого буфера точок і повторного
                  входу, а поверх цієї збірки нова стає нормально.
                */
                <p style={{ fontSize: "13px", color: "#6B7280", marginTop: "4px", lineHeight: 1.5 }}>
                  Натисніть «Завантажити APK» і підтвердіть «Оновити».
                  Застосунок стане поверх нинішнього: вхід, зміна й
                  незакинуті точки лишаться на місці. Якщо Android
                  несподівано скаже «пакет конфліктує» — на планшеті стоїть
                  давня збірка з іншим ключем: тоді видаліть застосунок і
                  поставте наново, трек і відмітки на сервері.
                </p>
              )}
            </div>
          ) : (
