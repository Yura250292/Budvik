 ...
 *
 * Туди синє, назад зелене: пара читається без легенди, бо це та сама пара,
 * якою всі звикли бачити «прямий і зворотний». Перша спроба фарбувала
 * повтор рожевим, і з нього не було видно головного — що це саме
 * ПОВЕРНЕННЯ, а не окремий вид їзди.
 *
 * Зелений тут насиченіший за зелений плану (той широка бліда смуга під
 * треком, 7 пікселів на 40% прозорості) — щоб дві зелені лінії не читалися
 * як одна сутність.
 *
 * Червоний і бурштиновий зайняті: перший означає «після зміни», другий —
...
export const MOVE_COLOR = {
  DRIVE: "#2563EB",
  WALK: "#D97706",
  /** Назад тією самою дорогою. */
  BACK: "#059669",
  /** Той самий проїзд удруге в тому ж напрямку — рідкість, але буває. */
  AGAIN: "#DB2777",
} as const;
