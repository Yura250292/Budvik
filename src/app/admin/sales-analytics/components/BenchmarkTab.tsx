        ...
        <Card>
          <div className="flex flex-wrap items-baseline justify-between gap-2">
            <CardHeader
              ...
              hint={
                picked
                  ? `Обрано ${picked.size} із ${roster.length}. Місця й медіани рахуються всередині вибірки${picked.size < 4 ? "; менше чотирьох — без порівняння, лише числа" : ""}.`
      ...
      <Card padded={false}>
        <div className="p-4 sm:p-5">
          <CardHeader
            ...
            hint={
              data.comparable
                ? "Заливка показує місце в команді: зелене — верхня чверть, червоне — нижня. Дебіторка й втрачені клієнти рахуються навпаки — менше означає краще."
