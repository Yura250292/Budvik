      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="relative flex items-center justify-between h-14 md:h-16 gap-3">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0">
            ...
            <Link href="/wishlist" className="relative md:hidden flex items-center justify-center text-white/60 hover:text-red-400 transition p-1.5" title="Обране">
            ...
            {/* Mobile: cart icon */}
            <Link href="/cart" className="relative md:hidden flex items-center justify-center text-white/70 hover:text-[#FFD600] transition p-1.5" title="Кошик">
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z" />
              </svg>
              {cartCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-[#FFD600] text-[#0A0A0A] text-[9px] w-4 h-4 rounded-full flex items-center justify-center font-bold">
            ...
            {session && (
              <Link
                ...
                className="flex items-center gap-1 bg-[#FFD600] text-[#0A0A0A] px-2 md:px-2.5 py-1.5 rounded-lg text-xs font-semibold hover:bg-[#FFC400] transition"
              >
            ...
            {session ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="hidden md:block text-sm bg-white/10 border border-white/20 text-white px-3 py-1.5 rounded-[10px] hover:bg-white/20 transition font-medium"
                >
                  Вийти
                </button>
              </div>
