...
const SOURCES_BY_KIND: Record<"rep" | "team", { values: InsightSource[]; description: string }> = {
  ...
  team: {
    ...
    description:
      "benchmark — показники й перцентилі команди; strengths — сильні та слабкі сторони; brands — прогалини по брендах.",
  },
};
...
найкращий у команді, 0 — найгірший. Для простроченої дебіторки, втрачених
клієнтів і частки повернень шкала перевернута: високий перцентиль означає,
що показник добрий (тобто борг малий, повернень мало).
