...
/**
 * Робоча область — Україна з невеликим запасом.
 *
 * Усі 379 клієнтів лежать у 48.1–50.5 пн.ш. і 22.3–37.3 сх.д., але карта
 * без обмежень легко відпливає на Польщу з Білоруссю: досить відтиснути
 * пальцем на планшеті, і водій дивиться на порожні тайли, не розуміючи,
 * куди подівся Львів. Рамка ширша за фактичний розкид — щоб точка біля
 * самого кордону не впиралася в край, — але не настільки, щоб загубитись.
 */
 ...
 * а не як збій. minZoom тримає масштаб не дрібнішим за країну.
 */
