 ...
 *
 * Оновлюється саме, раз на хвилину. Ручна кнопка теж є: коли людині щойно
 * сказали відкрити застосунок, чекати хвилину незручно — і саме для цього
 * кнопка, а не частіший таймер. Пульс пишеться раз на три хвилини, тож
 * двадцятисекундне опитування тричі поспіль показувало ту саму картину і
 * тричі платило за неї запитом до бази.
 */
