...
const NOT_A_NAME =
  ...
  /^((цьому|цього|цей|тому|того|цим|нашому|нашого|своєму)\s+)?(клієнт[а-яіїєґ]*|боржник[а-яіїєґ]*|магазин[а-яіїєґ]*|точ[кц][а-яіїєґ]*|контрагент[а-яіїєґ]*|йому|його|їм|когось|кого|всіх|усіх|них|мої|моїх|сьогодні|завтра|тут|це|щось|грош[а-яіїєґ]*|борг[а-яіїєґ]*|оплат[а-яіїєґ]*|замовлен[а-яіїєґ]*|продаж[а-яіїєґ]*|повернен[а-яіїєґ]*|точ[а-яіїєґ]*|нагадуван[а-яіїєґ]*|маршрут[а-яіїєґ]*|план[а-яіїєґ]*|артикул[а-яіїєґ]*|код[и]?|штрихкод[а-яіїєґ]*|назв[а-яіїєґ]*|ціну|ціни|залишок|залишки|наявність)$|^за\s+(тиждень|тижн[а-яіїєґ]*|місяц[ья]?|день|дні|днів|\d+\s*дн[а-яіїєґ]*|квартал|сьогодні|вчора)$/i;
