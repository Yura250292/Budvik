    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        <div className="bg-white border rounded-xl p-5">
          ...
          <p className="text-xs text-yellow-600 mt-1">{stats.activeOrders} активних</p>
        </div>
        <div className="bg-white border rounded-xl p-5">
        ...
        {role === "ADMIN" && (
          <>
            ...
            <div className="bg-white border rounded-xl p-5">
              <h3 className="text-xs text-gray-500 uppercase tracking-wide mb-1">Оптовиків</h3>
              <p className="text-3xl font-bold text-yellow-600">{stats.wholesale}</p>
              {stats.pendingWholesale > 0 && (
                <p className="text-xs text-yellow-600 mt-1">{stats.pendingWholesale} заявок</p>
              )}
            </div>
            <div className="bg-white border rounded-xl p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link href="/admin/orders" className="bg-white border rounded-xl p-6 hover:shadow-md transition group">
          ...
          <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 mb-1">Замовлення</h3>
        ...
        {role === "ADMIN" && (
          <>
            <Link href="/admin/products" className="bg-white border rounded-xl p-6 hover:shadow-md transition group">
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 mb-1">Товари</h3>
            ...
            <Link href="/admin/users" className="bg-white border rounded-xl p-6 hover:shadow-md transition group">
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 mb-1">Клієнти</h3>
              <p className="text-sm text-gray-500">Профілі, історія замовлень, призначення ролей</p>
            </Link>

            <Link href="/admin/wholesale" className="bg-white border rounded-xl p-6 hover:shadow-md transition group">
              <div className="w-10 h-10 bg-yellow-100 rounded-lg flex items-center justify-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
              <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 mb-1">Заявки оптовиків</h3>
              <p className="text-sm text-gray-500">Розгляд та управління заявками{stats.pendingWholesale > 0 ? ` (${stats.pendingWholesale} нових)` : ""}</p>
            </Link>
            ...
            <Link href="/admin/sales" className="bg-white border rounded-xl p-6 hover:shadow-md transition group">
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 mb-1">Торгові менеджери</h3>
            ...
            <Link href="/admin/integration" className="bg-white border rounded-xl p-6 hover:shadow-md transition group">
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 mb-1">Інтеграція 1С</h3>
