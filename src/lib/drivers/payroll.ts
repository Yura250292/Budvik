...
export function calculateRouteSheetPay(
  ...
  // База відсотка = підсумок маршрутного листа мінус оплати заборгованості.
  //
  // У підсумок листа 1С зводить рядки ДВОХ видів: реалізації (товар, який
  // водій везе сьогодні) і «Оплата заборгованості» (старий борг, який він
  // забирає). Відсоток нараховується лише за розвозку.
  //
  // Приклад власника, лист №1817 від 11.08.2026: підсумок 71 966,52, у ньому
  // рядок «Оплата заборгованості 000001242» на 5 888,00 →
  // (71 966,52 − 5 888,00) × 0,5% = 330,39 ₴.
  //
  // База не буває від'ємною: якщо боргів забрали більше, ніж привезли товару,
  // водій не «винен» компанії відсоток — просто немає бази.
