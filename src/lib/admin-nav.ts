...
export const TOP_ITEMS: NavItem[] = [
  ...
  // Поруч із дашбордом: там суми, тут — що відбувається просто зараз
  // (оплати, накладні, повернення, візити по всіх торгових).
  { href: "/admin/feed", title: "Стрічка подій", desc: "Оплати, накладні, повернення по всіх торгових", iconKey: "report", roles: AM },
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Адреса адмінська, а не /sales/catalog: той самий екран, але в шеллі
      // панелі, а не в кабінеті торгового з нижнім меню під планшет.
      { href: "/admin/catalog", title: "Каталог товарів", desc: "Номенклатура за брендами й групами", iconKey: "products", roles: ALL },
