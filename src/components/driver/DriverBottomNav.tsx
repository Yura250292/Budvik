 ...
 *
 * «Карта дня» (/driver/tablet) свідомо НЕ в цьому меню: там повноекранний
 * режим для планшета в тримачі, і нижня панель забирала б у карти висоту.
 * Вхід у неї — велика кнопка на «Сьогодні», вихід — кнопка в шапці самої
 * карти (без неї водій застрягав: апаратна «назад» з домашнього екрана
 * закриває вкладку, а не повертає в кабінет).
 */
const tabs = [
  {
    href: "/driver",
...
export default function DriverBottomNav() {
  ...
  // Повноекранна карта дня живе без навбара: планшет у тримачі, і кожен
  // піксель висоти — це видима територія.
  if (pathname?.startsWith("/driver/tablet")) return null;
