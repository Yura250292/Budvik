...
/**
 * Розділ «Аналітика водіїв»: усе, що стосується ролі водія, в одному місці.
 *
 * Живе власною сторінкою поруч з «Аналітикою торгових» у меню, а не її
 * підвкладкою: люди й показники різні — у торгового поїздки й паливо,
 * у водія доставка й зарплата за листами.
 *
...
export function DriversShell() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold text-bk sm:text-2xl">Аналітика водіїв</h1>
