/**
 * Публікація розібраного каталогу «12 Atelie» у R2.
 *
 ...
 * одного):
 *   catalogs/atelie/2026/catalog.pdf
 *   catalogs/atelie/2026/index.json
 *   catalogs/atelie/2026/photos/951607.jpg   ← один файл на знімок
 *   catalogs/atelie/latest.json              ← вказівник на свіже видання
 *
 * Запуск:
 *   npx tsx --env-file=.env scripts/atelie-catalog/publish.mts \
 *     output/atelie-catalog/2026 --pdf "~/Downloads/Каталог 12 Atelie 2026.pdf"
 */
...
const prefix = `catalogs/atelie/${year}`;
...
await uploadFile(
  ...
  "catalogs/atelie/latest.json",
  "application/json"
);
console.log(`Готово: ${indexUrl}`);
console.log(`Вказівник: ${publicUrl}/catalogs/atelie/latest.json`);
