      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="relative flex items-center justify-between h-14 md:h-16 gap-3">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0 overflow-hidden">
            ...
            <Link href="/wishlist" className="relative md:hidden flex items-center justify-center text-white/60 hover:text-red-400 transition p-1" title="Обране">
            ...
            {/* Mobile: cart icon */}
            <Link href="/cart" className="relative md:hidden flex items-center justify-center text-white/70 hover:text-[#FFD600] transition p-1" title="Кошик">
            ...
            {session && (
              <Link
                ...
                className="md:hidden flex items-center justify-center bg-[#FFD600] text-[#0A0A0A] w-7 h-7 rounded-full transition"
                title="Болти"
              >
            ...
            {session && (
              <Link
                href="/dashboard/loyalty"
                className="hidden md:flex items-center gap-1 bg-[#FFD600] text-[#0A0A0A] px-2.5 py-1.5 rounded-lg text-xs font-semibold hover:bg-[#FFC400] transition"
              >
            ...
            {session ? (
              <div className="hidden md:flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-sm bg-white/10 border border-white/20 text-white px-3 py-1.5 rounded-[10px] hover:bg-white/20 transition font-medium"
                >
                  Вийти
                </button>
              </div>
