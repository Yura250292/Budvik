...
| **Агент цін** | [`pricing/agent/run.ts`](../src/lib/pricing/agent/run.ts) | 01:00–06:00 — переперевірка сторінок сайтів (раз на тиждень кожна) і пошук нових сторінок моделлю, до `PRICE_AGENT_PER_NIGHT` товарів за ніч; щопонеділка з 08:00 — пропозиції цін на затвердження і підсумок у Telegram. Ціну на вітрині не змінює ([`docs/pricing.md`](../docs/pricing.md)) |
...
| `ANTHROPIC_API_KEY` | пошук сторінок товарів агентом цін. Без неї агент складає пропозиції лише з уже відомих сторінок |
| `PRICE_AGENT_PER_NIGHT` | скільки товарів агент шукає за ніч, типово 10 (≈ $10–17 на тиждень) |
