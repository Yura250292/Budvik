 ...
 *
 * Плюс у кінці — бо номер буває подвійний, через пробіл: у базі є категорія
 * «1. 5. Кутові шліфмашини (болгарки) акумуляторні». Без повторення знімався
 * лише перший номер, і в підказках пошуку покупець бачив «5. Кутові
 * шліфмашини (болгарки) акумуляторні».
 */
