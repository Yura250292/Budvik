 ...
 *
 * **Звідки вони беруться.** Застосунок ловить їх і сам (`fix-gate.ts`): з
 * 1.6.5 підозрілий фікс притримується до наступного і відкидається, якщо слід
 * повернувся. Але планшет бачить лише одного сусіда справа і не бачить
 * історії, записаної старішими збірками, — до 14.09 там стояло правило «п'ять
 * відкинутих поспіль, шоста хай там що», яке пропускало кожну шосту точку
 * довгої стоянки (і, як з'ясувалося, різало поїздки на Lenovo, що звітують
 * «швидкість 0» на ходу).
 *
