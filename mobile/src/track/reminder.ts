 ...
 * більшості (найпізніший звичний фініш у базі — 20:10), друге — коли про
 * незакриту зміну дізнається офіс, третє — остання спроба перед тим, як
 * о 20:00–23:00 за справу візьметься сервер.
 */
const HOURS: Array<{ hour: number; minute: number; body: string }> = [
  ...
  },
  {
    ...
    minute: 0,
    /**
     * Єдине нагадування, яке називає наслідок, а не прохання: рівно о цій
     * годині воркер пише в чат офісу «не закрив зміну». Сказати про це
     * прямо чесніше, ніж повторити ввічливе «зміна ще відкрита», — і дає
     * людині останню хвилину закрити її самій, поки розмови не було.
     */
    body: "Робочий день скінчився, а зміна відкрита — офіс уже бачить це. Сфотографуйте одометр, поки машина поруч.",
  },
  {
    hour: 21,
    minute: 0,
