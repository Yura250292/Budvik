    ...
    execFileSync(
      ...
      ["eas", "update", "--channel", "staff", "--platform", "android", "--message", message],
      {
        ...
        env: {
          ...
          /**
           * Підміняємо runtime ЗАВЖДИ, і для поточної теж.
           *
           * Досі поточну публікували без підміни — «хай конфіг говорить сам за
           * себе». 14.09.2026 конфіг уже казав 1.6.5 (збірка йшла на EAS), а
           * app-builds.ts ще 1.6.4, і виправлення поїхало під staff-1.6.5, де
           * немає жодного планшета, оминувши трьох людей на 1.6.4. Версія з
           * пульсу — це і є те, що стоїть у полі; конфіг може її випереджати.
           */
          STAFF_OTA_RUNTIME: v,
        },
      }
