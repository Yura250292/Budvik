    ...
    if (mode === "day_plan") {
      ...
      return {
        ...
        примітка: [
          ...dayNotes,
          ...plan.notes,
          "Гроші рейсу: вал накладних (сума мінус собівартість) − пальне на повний день з дорогою назад − оплата водію за формулою зарплати = лишається фірмі. Оплату водію пораховано з кілометрів дня з дорогою назад — так буде, коли адмін введе фактичний пробіг; поки його не введено, зарплата бере лише шлях до останньої точки, і тариф за км може вийти нижчим. Відкладені точки в ці числа не входять. Waze багатоточкових маршрутів за посиланням не приймає — для навігації по точках давай посилання Google.",
