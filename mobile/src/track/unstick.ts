 ...
 *
 * Мітка спільна з `deaf-dispatch.ts`: там інша причина того самого рестарту, і
 * два лікарі, кожен зі своїм лічильником, перезавантажили б застосунок двічі
 * поспіль. Експортовано саме заради цього.
 */
export const RELOAD_EVERY_MS = 30 * 60_000;
export const RELOAD_KEY = "unstickReloadAt";
