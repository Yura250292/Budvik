...
export default function ProductCard({ id, name, slug, description, price, stock, category }: ProductCardProps) {
    ...
    <Link href={`/catalog/${slug}`} className="group">
      <div className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow bg-white">
        <div className="h-48 bg-gray-100 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20 text-gray-300 group-hover:text-orange-300 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="p-4">
          ...
          <h3 className="font-semibold text-gray-900 mb-1 group-hover:text-orange-600 transition line-clamp-2">
            {name}
          </h3>
