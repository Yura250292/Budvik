...
async function pnlReport(period: ReturnType<typeof periodFromArgs>) {
  ...
  return {
    ...
    разом: {
      ...
      витрати_магазинів: uah(p.total.storeExpenses),
      результат_без_витрат_магазинів: p.total.resultExStores === null ? null : uah(p.total.resultExStores),
    },
