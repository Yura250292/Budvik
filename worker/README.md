...
| **Ринкові ціни** | [`pricing/market/refresh.ts`](../src/lib/pricing/market/refresh.ts) | 01:00–06:00, до 250 сторінок сайтів виробників за чверть години; ціна змінилась — перерахунок вітрини ([`docs/pricing.md`](../docs/pricing.md)) і скидання кешу |
