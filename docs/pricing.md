...
- **Підлога** — опт × **1,10** (загальне правило з 14.09.2026), і в будь-якому
  разі хоч на гривню дорожче опту. Опт з 1С уже заробляє 20–32 % над
  собівартістю, тож +10 % — додатковий заробіток, який покриває оплату карткою
  й доставку. При +10 % дорожчими за ринок лишаються 70 із 1124 товарів, що
  продаються; при +20 % — уже 357 (APRO).
- **Правила брендів** (адмінка, «Бренди»): SOMA FIX — підлога +20 % і Ataman —
  +15 % (опт там заробляє лише 7–8 %), Grösser — +5 % (імпортер продає на 9 %
  дорожче за наш опт), STREND PRO — +30 % (собівартість в обліку дорівнює опту,
  нижче базової ціни не опускаємо).
