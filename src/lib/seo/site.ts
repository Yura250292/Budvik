...
export const SITE_CONTACTS = {
  ...
  // Те саме людськими очима. Було вписано просто текстом у футер, і коли
  // контакти знадобились іще в трьох місцях (мобільне меню, сторінка 404,
  // «не знайшли товар»), номер довелось би дублювати щоразу.
  phoneDisplay: "077 270 00 27",
  phoneAltDisplay: "093 270 00 27",
