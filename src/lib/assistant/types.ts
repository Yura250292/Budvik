...
/**
 * Хто питає: торговий, водій чи складовщик.
 *
 * Це не косметика й не роль у базі, а три різні набори питань. Торговому
 ...
 * водія, ні на складовщика не оформлюють, портфеля в них немає. Саме тому
 * вид визначає і промпт, і перелік інструментів, а не лише формулювання.
 */
export type AssistantKind = "SALES" | "DRIVER" | "WAREHOUSE";
