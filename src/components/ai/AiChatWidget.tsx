...
export default function AiChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="ai-chat-mobile md:fixed md:inset-auto md:bottom-22 md:right-4 md:w-[440px] md:rounded-xl md:max-w-[calc(100vw-2rem)] md:h-[600px] md:shadow-2xl md:border md:border-[#EFEFEF]">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#0A0A0A] to-[#1A1A1A] text-white px-4 py-3 md:rounded-t-xl flex items-center gap-3 safe-area-top flex-shrink-0">
          ...
          {/* Messages */}
          <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain p-4 space-y-3" style={{ WebkitOverflowScrolling: "touch" }}>
            {messages.length === 0 && (
          ...
          {/* Input */}
          <div className="border-t p-3 safe-area-bottom flex-shrink-0">
