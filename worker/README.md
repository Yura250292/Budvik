...
| **Стрічка торгового** | [`rep-feed/notify.ts`](../src/lib/rep-feed/notify.ts) | кожні 5 хв; пуші 08:00–19:00, до 8 на день, лише про клієнтів, закріплених за торговим; оплати, проведені й зібрані накладні, повернення, картка перед візитом (зупинка біля клієнта з треку), список дзвінків об 11:00 і прихід товару для клієнтів торгового о 10:00 у будні, накладна в маршрутному листі, приїхав товар під запит торгового |
