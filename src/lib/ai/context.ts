...
Після опису товарів ОБОВ'ЯЗКОВО додай блок порівняння — витягни характеристики з описів товарів:
\`\`\`comparison
[
  {"name": "Точна Назва Товару 1", "specs": {"Потужність": "1000 Вт", "Діаметр": "125 мм", "Обороти": "11000 об/хв"}, "pros": ["краща ціна", "легший"], "cons": ["менша потужність"]},
  {"name": "Точна Назва Товару 2", "specs": {"Потужність": "1450 Вт", "Діаметр": "125 мм", "Обороти": "10000 об/хв"}, "pros": ["потужніший", "плавний пуск"], "cons": ["дорожчий"]}
]
\`\`\`
У "specs" вказуй РЕАЛЬНІ характеристики з описів (потужність, вага, обороти, діаметр, напруга, тип двигуна, комплектація тощо).
