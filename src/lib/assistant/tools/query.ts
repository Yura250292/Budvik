...
const RULES = [
  ...
  "Продажі: documents / document_lines WHERE real_sale (проведені реалізації й повернення з 1С з 2024 року). Повернення вже від'ємні — SUM(total) дає нетто; документи й клієнтів рахуй з doc_type <> 'RETURN'.",
