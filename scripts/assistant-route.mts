...
const ADMIN_CASES = [
  ...
  // 22–23.09.2026: під кожним торговим його клієнти (view reps) і одна
  // таблиця клієнт → торговий (view clients).
  "Дебіторка по торгових та їх клієнтах",
  "Дебіторка по клієнтах",
  "Борги по клієнтах і які торгові з ними працюють",
  "Дебіторка по Кулику",
  "Хто винен фірмі",
  "Найбільші боржники",
...
const ADMIN_HARD = [
  ...
  "Зроби Excel: що замовити по бренду APRO",
  "Скинь PDF дебіторки",
  "Файл для 1С по дефіциту СИЛА",
  // 22.09.2026 перше забрав код і відповів зведенням фірми без імен;
  // решта — фільтри й розрізи, яких кодова відповідь не вміє.
  "повний аналіз дебіторки по Торгових Олександр , Валентин, Джумага, Передрій , кулик",
  "не враховуй працівників тільки клієнти зроби топ 15 клієнтів які прострочили більше ніж 15 днів",
  "Дебіторка в розрізі торгових за 30 днів",
];
