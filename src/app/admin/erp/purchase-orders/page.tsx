        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p style={{ fontSize: "14px", color: "#6B7280" }}>Прихідні накладні від постачальників</p>
            </div>
          </div>
          <Link
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6" style={{ paddingTop: "24px", paddingBottom: "40px" }}>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p style={{ color: "#9E9E9E", fontSize: "16px" }}>Накладних не знайдено</p>
          </div>
        ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr style={{ background: "#FAFAFA", borderBottom: "1px solid #EFEFEF" }}>
                    ...
                    <th style={{ padding: "12px 16px", textAlign: "left", fontSize: "13px", fontWeight: 600, color: "#6B7280" }}>Постачальник</th>
                    ...
                    <th style={{ padding: "12px 16px", textAlign: "left", fontSize: "13px", fontWeight: 600, color: "#6B7280" }}>Створив</th>
                  </tr>
                </thead>
                <tbody>
                  {orders.map((o) => (
                    <tr key={o.id} className="hover:bg-gray-50 transition-colors" style={{ borderBottom: "1px solid #F3F4F6" }}>
