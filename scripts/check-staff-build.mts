...
const NATIVE = [
  ...
  "mobile/package.json",
  /**
   * Латки чужих бібліотек. Тут вони змішані — у тому самому файлі буває і
   * Java, і зібраний JS, — тож рахуємо весь каталог нативним: JS-частина
   * доїде й наступним оновленням, а Java без APK не доїде ніколи.
   *
   * 22.09.2026 саме цього тут бракувало: у латку expo-task-manager лягло
   * виправлення, через яке планшет Передрія п'ять днів не писав трек, а звірка
   * сказала «доїде повітрям» — тобто пообіцяла те, чого не буває.
   */
  "mobile/patches/",
];
