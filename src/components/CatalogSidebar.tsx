          ...
          <div className="p-2">
            {activeBrand && (
              <Link
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded text-sm text-orange-600 hover:bg-orange-50 transition mb-1"
              >
            ...
            {brands.length > 10 && (
              <button
                ...
                className="w-full text-center text-sm text-orange-600 hover:underline py-2"
              >
