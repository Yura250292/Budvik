...
export default function WarehouseOrdersPage() {
  ...
  // Перевірку ролі робить WarehouseGate у layout секції — з урахуванням стану
  // "loading". Тут вона стояла без нього, і поки їхала сесія, сторінка
  // встигала показати «Доступ заборонено» самому складовщику.
