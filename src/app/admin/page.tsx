...
export default function AdminPage() {
  ...
  // Модулі згруповані в секції за частотою щоденного використання.
  // Порожні секції (усі картки сховані за роллю) не рендеряться —
  // інакше SALES бачив би голі заголовки.
  const moduleSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: "Акції",
          desc: "Знижки, кешбек, об'ємні ціни",
          roles: ["ADMIN", "MANAGER"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: "Аналітика торгових",
          desc: "Продажі, КПІ, маршрути, паливо",
          roles: ["ADMIN", "MANAGER", "SALES"],
        },
        {
          href: "/admin/reports",
          ...
          title: "Звіти",
          desc: "Склад і торгові представники",
          roles: ["ADMIN", "MANAGER"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          href: "/admin/client-folders",
          icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
            </svg>
          ),
          title: "Папки клієнтів",
          desc: "Шаблони напрямків для торгових",
          roles: ["ADMIN", "MANAGER"],
        },
      ],
    },
      ...
      items: [
        {
          ...
          title: "Синхронізація 1С",
          desc: "Порівняння з базою, розбіжності",
          roles: ["ADMIN", "MANAGER"],
        },
        {
          href: "/admin/erp/scan",
