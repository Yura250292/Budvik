      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-14 md:h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            <Image src="/logo.png" alt="БУДВІК" width={36} height={36} className="h-8 w-auto md:h-9 invert" />
            <div className="flex flex-col">
              <span className="text-lg md:text-xl font-bold text-[#FFD600] leading-tight">БУДВІК</span>
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className="text-xs border border-[#FFD600]/40 text-[#FFD600] px-2.5 py-1 rounded-lg hover:bg-[#FFD600]/10 transition"
            >
              Передзвонити
            </button>
          </div>
          ...
          <div className="flex items-center gap-3">
            {/* Wishlist - desktop */}
            <Link href="/wishlist" className="relative hidden md:flex items-center justify-center text-white/60 hover:text-red-400 transition p-2">
            ...
            {/* Compare - desktop */}
            <Link href="/compare" className="relative hidden md:flex items-center justify-center text-white/60 hover:text-[#FFD600] transition p-2">
