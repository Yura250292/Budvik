...
- **Обидва ключі Gemini станом на 17.09.2026 — безкоштовний тариф** (20 запитів на
  добу на модель і кілька на хвилину): після 5–10 ходів керівника відповідає
  DeepSeek. Щоб зняти ліміт, у Google AI Studio для проєкту ключа помічника
  треба ввімкнути білінг — ключ і деплой міняти не потрібно.
